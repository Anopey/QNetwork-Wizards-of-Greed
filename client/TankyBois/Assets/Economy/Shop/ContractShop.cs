...
public class ContractShop
{
    ...
    public ContractShop()
    {
        ...
        contracts.Insert(0, new Contract(0, 0, 3, 2));
        contracts.Insert(0, new Contract(0, 3, 1, 2));
        contracts.Insert(0, new Contract(0, 0, 0, 5));
        contracts.Insert(0, new Contract(0, 0, 1, 4));
        contracts.Insert(0, new Contract(0, 2, 2, 3));
        contracts.Insert(0, new Contract(2, 2, 1, 1));
    }
